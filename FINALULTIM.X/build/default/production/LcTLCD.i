...
void LcInit(char rows, char columns) {
 ...
 RowAct = ColumnAct = 0;
 (TRISBbits.RB3 = TRISBbits.RB4 = TRISBbits.RB5 = 0);
 for (i = 0; i < 2; i++) {
  Espera(Timer, 100);
...
void CantaPartAlta(char c) {
  (LATCbits.LATC0 = (c & 0x80 ? 1 : 0));
  (LATCbits.LATC1 = (c & 0x40 ? 1 : 0));
  (LATCbits.LATC2 = (c & 0x20 ? 1 : 0));
  (LATCbits.LATC3 = (c & 0x10 ? 1 : 0));
}

void CantaPartBaixa(char c) {
  (LATCbits.LATC0 = (c & 0x08 ? 1 : 0));
  (LATCbits.LATC1 = (c & 0x04 ? 1 : 0));
  (LATCbits.LATC2 = (c & 0x02 ? 1 : 0));
  (LATCbits.LATC3 = (c & 0x01 ? 1 : 0));
}

void CantaIR(char IR) {
 (TRISCbits.RC0 = TRISCbits.RC1 = TRISCbits.RC2 = TRISCbits.RC3 = 0);
 (LATBbits.LATB3 = 0);
 (LATBbits.LATB4 = 0);
 (LATBbits.LATB5 = 1);
 CantaPartAlta(IR);
 ...
 (LATBbits.LATB5 = 1);
 (LATBbits.LATB5 = 0);
 (TRISCbits.RC0 = TRISCbits.RC1 = TRISCbits.RC2 = TRISCbits.RC3 = 1);
}
...
void EscriuPrimeraOrdre(char ordre) {
 ...
 (TRISCbits.RC0 = TRISCbits.RC1 = TRISCbits.RC2 = TRISCbits.RC3 = 0); (LATBbits.LATB3 = 0); (LATBbits.LATB4 = 0);
 (LATBbits.LATB5 = 1); (LATBbits.LATB5 = 1);
  (LATCbits.LATC0 = (ordre & 0x08 ? 1 : 0));
  (LATCbits.LATC1 = (ordre & 0x04 ? 1 : 0));
  (LATCbits.LATC2 = (ordre & 0x02 ? 1 : 0));
  (LATCbits.LATC3 = (ordre & 0x01 ? 1 : 0));
 (LATBbits.LATB5 = 0);
}
