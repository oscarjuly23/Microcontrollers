...
void LcGotoXY(char Columna, char Fila) {
 ...
 switch (Files) {
  ...
  case 4:
   ...
   if (Fila == 2) Fisica += Columnes; else
   if (Fila == 3) Fisica += 0x40+Columnes;
   break;
  case 1:
  default:
...
void CantaPartAlta(char c) {
  (LATCbits.LATC1 = (c & 0x80 ? 1 : 0));
  (LATCbits.LATC0 = (c & 0x40 ? 1 : 0));
  (LATCbits.LATC2 = (c & 0x20 ? 1 : 0));
  (LATCbits.LATC3 = (c & 0x10 ? 1 : 0));
}

void CantaPartBaixa(char c) {
  (LATCbits.LATC1 = (c & 0x08 ? 1 : 0));
  (LATCbits.LATC0 = (c & 0x04 ? 1 : 0));
...
void EscriuPrimeraOrdre(char ordre) {
 ...
 (LATBbits.LATB5 = 1); (LATBbits.LATB5 = 1);
  (LATCbits.LATC1 = (ordre & 0x08 ? 1 : 0));
  (LATCbits.LATC0 = (ordre & 0x04 ? 1 : 0));
